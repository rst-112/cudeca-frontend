  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 items-center">
          ...
          {filterButtons.map((filter) => {
            ...
            return (
              <button
                ...
                className={`px-6 py-2 rounded-full font-semibold transition-all [font-family:'Arimo-Regular',Helvetica] ${
                  isActive
        ...
        <button
          className="px-6 py-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-600 rounded-lg font-semibold hover:shadow-md transition-all [font-family:'Arimo-Regular',Helvetica]"
