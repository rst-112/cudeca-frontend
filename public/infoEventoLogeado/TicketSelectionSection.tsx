...
export const TicketSelectionSection = (): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full h-48 bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-600 rounded-lg flex items-center justify-center text-6xl"
        role="img"
          ...
          <div className="flex gap-2">
            {donationButtons.map((btn, index) => (
              <button
                ...
                onClick={() => handleDonationButtonClick(btn.value)}
                type="button"
