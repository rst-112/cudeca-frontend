...
export const EventGrid = ({ events }: EventGridProps) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {events.map((event) => (
                <Card key={event.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col h-full border-cudeca-gris-borde/40 bg-white">
                    ...
                    <CardContent className="space-y-5 flex flex-col grow">
                        ...
                        <div className="pt-2 mt-auto">
                            <Button asChild className="w-full bg-cudeca-verde hover:bg-cudeca-verde-dark text-white font-semibold h-11 group-hover:translate-y-[-2px] transition-all shadow-md hover:shadow-lg hover:shadow-cudeca-verde/20">
