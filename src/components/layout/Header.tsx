        ...
        <nav className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md">
            <div className="container mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Link to="/carrito" className="relative p-2 text-slate-700 dark:text-slate-200 hover:text-[#00A651] dark:hover:text-[#00A651] transition-colors">
                    ...
                    {authenticated ? (
                        <div className="flex items-center gap-2">
                            ...
                            {(user?.roles?.includes('ADMINISTRADOR') || user?.roles?.includes('PERSONAL_EVENTO') || user?.email === 'admin@test.com' || user?.email === 'staff@test.com') && (
                                <Button asChild variant="outline" className="gap-2 border-slate-300 dark:border-slate-700">
                                    <Link to={user?.roles?.includes('ADMINISTRADOR') || user?.email === 'admin@test.com' ? '/admin' : '/staff'} className="flex items-center gap-2">
                            ...
                            {/* Perfil de Usuario */}
                            <Button asChild variant="default" className="bg-[#00A651] hover:bg-[#008a43] text-white shadow-md hover:shadow-lg">
